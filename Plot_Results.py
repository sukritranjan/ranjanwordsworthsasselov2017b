...
plot_steadystate_doserates=True #Plot the dose rates as a function of stellar type
plot_steadystate_doserates_relative=True #Plot the bad/good dose rates as a function of stellar type

plot_flare_toa_surf=True #Plot the TOA fluxes and the surface radiances for each stellar type
plot_flare_doserates=True #Plot the dose rates as a function of stellar type
plot_flare_doserates_relative=True #Plot the bad/good dose rates as a function of stellar type
...
if plot_steadystate_toa_surf:
	...
	labels=np.array(['Young \nSun','GJ 832','GJ 176','AD Leo','GJ 667C','GJ 581','GJ 436','GJ 876','Prox Cen \n(MUSCLES)','GJ1214','R+2015 M8V'])
	...
	ax0.set_ylabel(r'Flux (photons/s/cm$^2$/nm)', fontsize=16)
	ax0.set_yscale('log')
	ax1.set_yscale('log')
	ax1.set_ylim([1.e5, 1.e15])
	ax1.set_ylabel(r'Surface Radiance (photons/s/cm$^2$/nm)', fontsize=16)
	...
	plt.savefig('./Plots/results_radiances_steadystate_toa_boa_spectype.pdf', orientation='portrait',papertype='letter', format='pdf')
...
if plot_steadystate_doserates:
	...
	abscissa=range(0, numelt)
	
	ax.plot(abscissa, dose_200_300, marker='s', markeredgewidth=0., markersize=markersizeval, linewidth=1, color=colors[1], label=r'Radiance 200-300 nm')	
	ax.plot(abscissa, dose_ump_193, marker='s', markeredgewidth=0., markersize=markersizeval, linewidth=1, color=colors[2], label=r'UMP Bond Cleavage ($\lambda_0=193$)')
	ax.plot(abscissa, dose_ump_230, marker='s', markeredgewidth=0., markersize=markersizeval, linewidth=1, color=colors[3], label=r'UMP Bond Cleavage ($\lambda_0=230$)')
	ax.plot(abscissa, dose_ump_254, marker='s', markeredgewidth=0., markersize=markersizeval, linewidth=1, color=colors[4], label=r'UMP Bond Cleavage ($\lambda_0=254$)')
	ax.plot(abscissa, dose_cucn3_254, marker='s', markeredgewidth=0., markersize=markersizeval, linewidth=1, color=colors[5], label=r'CuCN$_3$ Photoionization ($\lambda_0=254$)')
	ax.plot(abscissa, dose_cucn3_300, marker='s', markeredgewidth=0., markersize=markersizeval, linewidth=1, color=colors[6], label=r'CuCN$_3$ Photoionization ($\lambda_0=300$)')
...
if plot_steadystate_doserates_relative:
	...
	ax.plot(abscissa, dose_ump_193/dose_cucn3_254, marker='s', markeredgewidth=0., markersize=markersizeval, linewidth=1, color=colors[0], label=r'UMP-193/CuCN3-254')
	ax.plot(abscissa, dose_ump_230/dose_cucn3_254, marker='s', markeredgewidth=0., markersize=markersizeval, linewidth=1, color=colors[1], label=r'UMP-230/CuCN3-254')
	ax.plot(abscissa, dose_ump_254/dose_cucn3_254, marker='s', markeredgewidth=0., markersize=markersizeval, linewidth=1, color=colors[2], label=r'UMP-254/CuCN3-254')

	ax.plot(abscissa, dose_ump_193/dose_cucn3_300, marker='s', markeredgewidth=0., markersize=markersizeval, linewidth=1, color=colors[3], label=r'UMP-193/CuCN3-300')
	ax.plot(abscissa, dose_ump_230/dose_cucn3_300, marker='s', markeredgewidth=0., markersize=markersizeval, linewidth=1, color=colors[4], label=r'UMP-230/CuCN3-300')
	ax.plot(abscissa, dose_ump_254/dose_cucn3_300, marker='s', markeredgewidth=0., markersize=markersizeval, linewidth=1, color=colors[5], label=r'UMP-254/CuCN3-300')
	...
	ax.set_yscale('log')
	ax.set_ylabel(r'$\bar{D}_{UMP-X}/\bar{D}_{CuCN3-Y}$')

	ax.legend(bbox_to_anchor=[0, 1.13, 1., .152], loc=3, ncol=2, mode='expand', borderaxespad=0., fontsize=10)
	plt.tight_layout(rect=(0,0,1,0.8))
	plt.subplots_adjust(wspace=0., hspace=0.2)
